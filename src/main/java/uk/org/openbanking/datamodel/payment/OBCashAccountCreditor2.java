...
public class OBCashAccountCreditor2   {
  ...
  public OBCashAccountCreditor2 schemeName(String schemeName) {
...
@Size(min=1,max=40) 
  ...
  public OBCashAccountCreditor2 identification(String identification) {
...
@Size(min=1,max=256) 
  ...
  public OBCashAccountCreditor2 name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public OBCashAccountCreditor2 secondaryIdentification(String secondaryIdentification) {
...
@Size(min=1,max=34) 
  ...
  public boolean equals(Object o) {
    ...
    OBCashAccountCreditor2 obCashAccountCreditor2 = (OBCashAccountCreditor2) o;
    return Objects.equals(this.schemeName, obCashAccountCreditor2.schemeName) &&
        Objects.equals(this.identification, obCashAccountCreditor2.identification) &&
        Objects.equals(this.name, obCashAccountCreditor2.name) &&
        Objects.equals(this.secondaryIdentification, obCashAccountCreditor2.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBCashAccountCreditor2 {\n");
