...
public class OBTransaction2CreditorAccount   {
  /**
  ...
  public OBTransaction2CreditorAccount schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  public OBTransaction2CreditorAccount identification(String identification) {
...
@Size(min=1,max=34) 
  ...
  public OBTransaction2CreditorAccount name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public OBTransaction2CreditorAccount secondaryIdentification(String secondaryIdentification) {
...
@Size(min=1,max=34) 
  ...
  public boolean equals(Object o) {
    ...
    OBTransaction2CreditorAccount obTransaction2CreditorAccount = (OBTransaction2CreditorAccount) o;
    return Objects.equals(this.schemeName, obTransaction2CreditorAccount.schemeName) &&
        Objects.equals(this.identification, obTransaction2CreditorAccount.identification) &&
        Objects.equals(this.name, obTransaction2CreditorAccount.name) &&
        Objects.equals(this.secondaryIdentification, obTransaction2CreditorAccount.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBTransaction2CreditorAccount {\n");
