...
public class OBStatement1Amount3   {
  @JsonProperty("Amount")
  ...
  public OBStatement1Amount3 amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBStatement1Amount3 currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBStatement1Amount3 obStatement1Amount3 = (OBStatement1Amount3) o;
    return Objects.equals(this.amount, obStatement1Amount3.amount) &&
        Objects.equals(this.currency, obStatement1Amount3.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBStatement1Amount3 {\n");
