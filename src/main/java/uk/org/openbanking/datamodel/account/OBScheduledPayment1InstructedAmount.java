...
public class OBScheduledPayment1InstructedAmount   {
  @JsonProperty("Amount")
  ...
  public OBScheduledPayment1InstructedAmount amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBScheduledPayment1InstructedAmount currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBScheduledPayment1InstructedAmount obScheduledPayment1InstructedAmount = (OBScheduledPayment1InstructedAmount) o;
    return Objects.equals(this.amount, obScheduledPayment1InstructedAmount.amount) &&
        Objects.equals(this.currency, obScheduledPayment1InstructedAmount.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBScheduledPayment1InstructedAmount {\n");
