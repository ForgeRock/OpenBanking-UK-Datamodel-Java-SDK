...
public class OBScheduledPayment1CreditorAccount   {
  /**
  ...
  public OBScheduledPayment1CreditorAccount schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  public OBScheduledPayment1CreditorAccount identification(String identification) {
...
@Size(min=1,max=34) 
  ...
  public OBScheduledPayment1CreditorAccount name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public OBScheduledPayment1CreditorAccount secondaryIdentification(String secondaryIdentification) {
...
@Size(min=1,max=34) 
  ...
  public boolean equals(Object o) {
    ...
    OBScheduledPayment1CreditorAccount obScheduledPayment1CreditorAccount = (OBScheduledPayment1CreditorAccount) o;
    return Objects.equals(this.schemeName, obScheduledPayment1CreditorAccount.schemeName) &&
        Objects.equals(this.identification, obScheduledPayment1CreditorAccount.identification) &&
        Objects.equals(this.name, obScheduledPayment1CreditorAccount.name) &&
        Objects.equals(this.secondaryIdentification, obScheduledPayment1CreditorAccount.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBScheduledPayment1CreditorAccount {\n");
