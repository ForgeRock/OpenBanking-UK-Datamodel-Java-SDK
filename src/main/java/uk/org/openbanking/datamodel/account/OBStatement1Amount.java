...
public class OBStatement1Amount   {
  @JsonProperty("Amount")
  ...
  public OBStatement1Amount amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBStatement1Amount currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBStatement1Amount obStatement1Amount = (OBStatement1Amount) o;
    return Objects.equals(this.amount, obStatement1Amount.amount) &&
        Objects.equals(this.currency, obStatement1Amount.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBStatement1Amount {\n");
