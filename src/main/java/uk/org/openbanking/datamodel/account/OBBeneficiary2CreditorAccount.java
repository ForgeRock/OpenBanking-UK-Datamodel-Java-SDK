...
public class OBBeneficiary2CreditorAccount   {
  /**
  ...
  public OBBeneficiary2CreditorAccount schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  public OBBeneficiary2CreditorAccount identification(String identification) {
...
@Size(min=1,max=34) 
  ...
  public OBBeneficiary2CreditorAccount name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public OBBeneficiary2CreditorAccount secondaryIdentification(String secondaryIdentification) {
...
@Size(min=1,max=34) 
  ...
  public boolean equals(Object o) {
    ...
    OBBeneficiary2CreditorAccount obBeneficiary2CreditorAccount = (OBBeneficiary2CreditorAccount) o;
    return Objects.equals(this.schemeName, obBeneficiary2CreditorAccount.schemeName) &&
        Objects.equals(this.identification, obBeneficiary2CreditorAccount.identification) &&
        Objects.equals(this.name, obBeneficiary2CreditorAccount.name) &&
        Objects.equals(this.secondaryIdentification, obBeneficiary2CreditorAccount.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBBeneficiary2CreditorAccount {\n");
