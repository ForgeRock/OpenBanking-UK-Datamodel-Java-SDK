...
public class OBStatement1Amount1   {
  @JsonProperty("Amount")
  ...
  public OBStatement1Amount1 amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBStatement1Amount1 currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBStatement1Amount1 obStatement1Amount1 = (OBStatement1Amount1) o;
    return Objects.equals(this.amount, obStatement1Amount1.amount) &&
        Objects.equals(this.currency, obStatement1Amount1.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBStatement1Amount1 {\n");
