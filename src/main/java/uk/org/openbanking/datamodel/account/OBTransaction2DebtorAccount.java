...
public class OBTransaction2DebtorAccount   {
  /**
  ...
  public OBTransaction2DebtorAccount schemeName(SchemeNameEnum schemeName) {
  ...
  **/
  ...
  public OBTransaction2DebtorAccount identification(String identification) {
...
@Size(min=1,max=34) 
  ...
  public OBTransaction2DebtorAccount name(String name) {
    this.name = name;
    return this;
  }
...
@Size(min=1,max=70) 
  ...
  public OBTransaction2DebtorAccount secondaryIdentification(String secondaryIdentification) {
...
@Size(min=1,max=34) 
  ...
  public boolean equals(Object o) {
    ...
    OBTransaction2DebtorAccount obTransaction2DebtorAccount = (OBTransaction2DebtorAccount) o;
    return Objects.equals(this.schemeName, obTransaction2DebtorAccount.schemeName) &&
        Objects.equals(this.identification, obTransaction2DebtorAccount.identification) &&
        Objects.equals(this.name, obTransaction2DebtorAccount.name) &&
        Objects.equals(this.secondaryIdentification, obTransaction2DebtorAccount.secondaryIdentification);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBTransaction2DebtorAccount {\n");
