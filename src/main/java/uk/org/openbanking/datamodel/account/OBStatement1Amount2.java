...
public class OBStatement1Amount2   {
  @JsonProperty("Amount")
  ...
  public OBStatement1Amount2 amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBStatement1Amount2 currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBStatement1Amount2 obStatement1Amount2 = (OBStatement1Amount2) o;
    return Objects.equals(this.amount, obStatement1Amount2.amount) &&
        Objects.equals(this.currency, obStatement1Amount2.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBStatement1Amount2 {\n");
