...
@Size(min=1,max=35) 
  ...
  public OBStandingOrder2Basic firstPaymentDateTime(DateTime firstPaymentDateTime) {
  ...
  **/
  ...
  public OBStandingOrder2Basic nextPaymentDateTime(DateTime nextPaymentDateTime) {
  ...
  **/
  ...
  public OBStandingOrder2Basic finalPaymentDateTime(DateTime finalPaymentDateTime) {
