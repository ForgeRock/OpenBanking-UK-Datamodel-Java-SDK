...
public class OBTransaction2Amount   {
  @JsonProperty("Amount")
  ...
  public OBTransaction2Amount amount(String amount) {
    this.amount = amount;
    return this;
  }
...
@Pattern(regexp="^\\d{1,13}\\.\\d{1,5}$") 
  ...
  public OBTransaction2Amount currency(String currency) {
...
@Pattern(regexp="^[A-Z]{3,3}$") 
  ...
  public boolean equals(Object o) {
    ...
    OBTransaction2Amount obTransaction2Amount = (OBTransaction2Amount) o;
    return Objects.equals(this.amount, obTransaction2Amount.amount) &&
        Objects.equals(this.currency, obTransaction2Amount.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class OBTransaction2Amount {\n");
